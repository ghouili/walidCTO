...
export function Stats() {
  return (
    <div className="stats-card bg-ink mt-20 rounded-3xl px-12 py-20 text-center text-white max-[900px]:rounded-[18px] max-[900px]:px-6 max-[900px]:py-12">
      <div className="relative z-[1]">
        <div className="mb-12 text-base font-medium tracking-[-0.01em] text-white/60">
          By the numbers
        </div>
        <div className="grid grid-cols-4 gap-12 max-[900px]:grid-cols-2 max-[900px]:gap-8">
          {stats.map((stat) => (
            <div key={stat.label}>
